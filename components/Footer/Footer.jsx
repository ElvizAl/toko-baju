      ...
      <div className="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full text-white">
            ...
            <div className="p-2 border sm:flex sm:items-center border-white/10">
              ...
              <button className="w-full h-12 px-6 py-3 mt-1 text-sm font-bold tracking-wide uppercase bg-red-700 sm:ml-4 sm:flex-shrink-0 sm:w-auto sm:mt-0" type="submit">
                Sign Up
              </button>
            </div>
          </form>
        ...
        <div className="col-span-2 pt-6 border-t sm:col-span-1 border-white/10">
          ...
          <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
            <a className="inline-block" href=""> 1on1 Coaching </a>
            <a className="inline-block" href=""> Company Review </a>
            <a className="inline-block" href=""> Accounts Review </a>
            <a className="inline-block" href=""> HR Consulting </a>
            <a className="inline-block" href=""> SEO Optimisation </a>
          </nav>
        </div>
        ...
        <div className="col-span-2 pt-6 border-t sm:col-span-1 border-white/10">
          ...
          <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
            ...
            <a className="inline-block" href=""> Meet the Team </a>
            <a className="inline-block" href=""> History </a>
            <a className="inline-block" href=""> Careers </a>
          </nav>
        </div>
        ...
        <div className="col-span-2 pt-6 border-t sm:col-span-1 border-white/10">
          ...
          <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
            ...
            <a className="inline-block" href=""> Live Chat </a>
          </nav>
        </div>
        ...
        <div className="col-span-2 pt-6 border-t sm:col-span-1 border-white/10">
          ...
          <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
            <a className="inline-block" href=""> Accessibility </a>
            <a className="inline-block" href=""> Returns Policy </a>
            <a className="inline-block" href=""> Refund Policy </a>
            <a className="inline-block" href=""> Hiring Statistics </a>
          </nav>
        </div>
        ...
        <div className="col-span-2 pt-6 border-t sm:col-span-1 border-white/10">
          ...
          <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
            <a className="inline-block" href=""> Marketing Calendar </a>
            <a className="inline-block" href=""> SEO Infographics </a>
          </nav>
        </div>
